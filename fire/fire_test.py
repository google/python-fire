...
class FireTest(testutils.BaseTestCase):
    def testFire(self):
        ...
        self.assertEqual(
            fire.Fire(tc.OldStyleWithDefaults, command=["triple", "4"]), 12
        )
    ...
    def testFireDefaultName(self):
        with mock.patch.object(
            sys, "argv", [os.path.join("python-fire", "fire", "base_filename.py")]
        ):
            with self.assertOutputMatches(
                stdout="SYNOPSIS.*base_filename.py", stderr=None
            ):
                fire.Fire(tc.Empty)
    ...
    def testFireNamedArgs(self):
        ...
        self.assertEqual(
            fire.Fire(tc.OldStyleWithDefaults, command=["double", "--count", "5"]), 10
        )
        self.assertEqual(
            fire.Fire(tc.OldStyleWithDefaults, command=["triple", "--count", "5"]), 15
        )
    ...
    def testFireAllNamedArgs(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--alpha", "1", "2"]), 5
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--beta", "1", "2"]), 4
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "1", "--alpha", "2"]), 4
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "1", "--beta", "2"]), 5
        )
        self.assertEqual(
    ...
    def testFireAllNamedArgsOneMissing(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["sum", "--alpha", "1"]), 1
        )
    ...
    def testFirePartialNamedArgs(self):
        ...
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["identity", "--alpha", "1", "--beta", "2"]
            ),
            (1, 2),
        )
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["identity", "--beta", "1", "--alpha", "2"]
            ),
            (2, 1),
        )
    ...
    def testFirePartialNamedArgsOneMissing(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "--alpha", "1"]), (1, "0")
        )
    ...
    def testFireRecursion(self):
        ...
        self.assertEqual(
            fire.Fire(tc.TypedProperties, command=["charlie", "triple", "w"]), "www"
        )
    ...
    def testFireKeywordArgs(self):
        ...
        self.assertEqual(
            fire.Fire(
                tc.Kwargs, command='props --message "This is a message it has -- in it"'
            ),
            {"message": "This is a message it has -- in it"},
        )
        self.assertEqual(
    ...
    def testFireObjectWithList(self):
        ...
        self.assertEqual(
            fire.Fire(tc.TypedProperties, command=["echo", "1"]), "bethany"
        )
    ...
    def testFireObjectWithListAsObject(self):
        self.assertEqual(
            fire.Fire(tc.TypedProperties, command=["echo", "count", "bethany"]), 1
        )

    def testFireObjectWithTupleAsObject(self):
        self.assertEqual(
            fire.Fire(tc.TypedProperties, command=["fox", "count", "divide"]), 1
        )
    ...
    def testFireUnderscores(self):
        self.assertEqual(
            fire.Fire(tc.Underscores, command=["underscore-example"]), "fish fingers"
        )
        self.assertEqual(
            fire.Fire(tc.Underscores, command=["underscore_example"]), "fish fingers"
        )
    ...
    def testBoolParsing(self):
        ...
        self.assertEqual(
            fire.Fire(tc.BoolConverter, command=["as-bool", "--arg"]), True
        )
        self.assertEqual(
    ...
    def testBoolParsingContinued(self):
        ...
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["identity", "--alpha", "--beta", "10"]
            ),
            (True, 10),
        )
        self.assertEqual(
    ...
    def testBoolParsingLessExpectedCases(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "True", "10"]), (True, 10)
        )
        ...
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["identity", "--alpha", "True", '"--test"']
            ),
            (True, "--test"),
        )
    ...
    def testSingleCharFlagParsing(self):
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a"]), (True, "0")
        )
        self.assertEqual(
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a", "-b"]), (True, True)
        )
        self.assertEqual(
        ...
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["identity", "--alpha", "True", "-b", "10"]
            ),
            (True, 10),
        )
        with self.assertRaisesFireExit(2):
    ...
    def testSingleCharFlagParsingEqualSign(self):
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "-a=True"]), (True, "0")
        )
        self.assertEqual(
    ...
    def testSingleCharFlagParsingExactMatch(self):
        self.assertEqual(
            fire.Fire(tc.SimilarArgNames, command=["identity2", "-a"]), (True, None)
        )
        self.assertEqual(
            fire.Fire(tc.SimilarArgNames, command=["identity2", "-a=10"]), (10, None)
        )
        self.assertEqual(
            fire.Fire(tc.SimilarArgNames, command=["identity2", "--a"]), (True, None)
        )
        self.assertEqual(
            fire.Fire(tc.SimilarArgNames, command=["identity2", "-alpha"]), (None, True)
        )
        self.assertEqual(
    ...
    def testBoolParsingWithNo(self):
        ...
        self.assertEqual(
            fire.Fire(fn1, command=["--thing", "--nonothing"]), (True, False)
        )
    ...
    def testHelpFlagAndTraceFlag(self):
        with self.assertRaisesFireExit(0, "Fire trace:\n.*SYNOPSIS"):
            fire.Fire(
                tc.BoolConverter, command=["as-bool", "True", "--", "--help", "--trace"]
            )
        with self.assertRaisesFireExit(0, "Fire trace:\n.*SYNOPSIS"):
    ...
    def testBasicSeparator(self):
        ...
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "+", "_"]), ("+", "_")
        )
        self.assertEqual(
            fire.Fire(tc.MixedDefaults, command=["identity", "_", "+", "-"]), ("_", "+")
        )
    ...
    def testSeparatorForChaining(self):
        ...
        self.assertIsInstance(
            fire.Fire(
                tc.ReturnsObj, command=["get-obj", "arg1", "arg2", "as-bool", "True"]
            ),
            tc.BoolConverter,
        )
    ...
    def testNegativeNumbers(self):
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["sum", "--alpha", "-3", "--beta", "-4"]
            ),
            -11,
        )
    ...
    def testFloatForExpectedInt(self):
        self.assertEqual(
            fire.Fire(
                tc.MixedDefaults, command=["sum", "--alpha", "2.2", "--beta", "3.0"]
            ),
            8.2,
        )
        self.assertEqual(
            fire.Fire(
                tc.NumberDefaults, command=["integer_reciprocal", "--divisor", "5.0"]
            ),
            0.2,
        )
        self.assertEqual(
            fire.Fire(tc.NumberDefaults, command=["integer_reciprocal", "4.0"]), 0.25
        )
    ...
    def testTraceErrors(self):
        ...
        with self.assertRaisesFireExit(2):
            fire.Fire(
                tc.InstanceVars, command=["--arg1=a1", "--arg2=a2", "-", "run b1"]
            )

        # Extra args cannot be consumed.
        with self.assertRaisesFireExit(2):
            fire.Fire(
                tc.InstanceVars, command=["a1", "a2", "-", "run", "b1", "b2", "b3"]
            )
        with self.assertRaisesFireExit(2):
            fire.Fire(
                tc.InstanceVars,
    ...
    def testFireAsyncio(self):
        self.assertEqual(
            fire.Fire(tc.py3.WithAsyncio, command=["double", "--count", "10"]), 20
        )
